...
///
/// ```
/// use speedb::{DB, Options, WriteBatch, WriteOptions};
///
...
///
/// ```
/// use speedb::{DB, Options, FlushOptions};
///
...
///
/// ```
/// use speedb::{DB, IngestExternalFileOptions, SstFileWriter, Options};
///
...
impl Options {
    ...
    ///
    /// ```
    /// use speedb::{Options, DBCompactionStyle};
    ///
    /// let mut opts = Options::default();
    /// opts.set_compaction_style(DBCompactionStyle::Universal);
    /// ```
    ...
    ///
    /// ```
    /// use speedb::{Options, MemtableFactory};
    /// let mut opts = Options::default();
    ...
    ///
    /// ```
    /// use speedb::{Options, CuckooTableOptions};
    ///
    /// let mut opts = Options::default();
    ...
    ///
    /// ```
    /// use speedb::{Options, PlainTableFactoryOptions};
    ///
    /// let mut opts = Options::default();
    ...
    ///
    /// ```
    /// use speedb::{Options, DBRecoveryMode};
    ///
    /// let mut opts = Options::default();
    ...
    ///
    /// ```
    /// use speedb::{Options, SliceTransform};
    ///
    /// let mut opts = Options::default();
